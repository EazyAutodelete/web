...
<svelte:head>
	...
	<meta
	content="See legal Information about the {$_("licenses")} of EazyAutodelete - the best & most customizable Autodelete Bot for Discord. Completely free & in unlimited channels. With EazyAutodelete's advanced configuration options, you can autodelete messages based on user roles, mentions, a large number of filters or time intervals. Set durations like 5 minutes, 1 hour, 1 day, 24 hour or 1 week."
	name="description"
/>
</svelte:head>
...
<PageContent>
	<div class="w-full">
		...
		<p class="text-justify">
			The following section sets forth attribution notices for third party software that may be contained in portions of
			this project. Thanks to all developers who have contributed to any of the third party software listed below.
		</p>
