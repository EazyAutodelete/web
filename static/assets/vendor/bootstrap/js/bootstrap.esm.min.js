...
const MAX_UID = 1e6,
	...
	getTransitionDurationFromElement = e => {
		...
		return i || s
			? ((t = t.split(",")[0]), (n = n.split(",")[0]), 1e3 * (Number.parseFloat(t) + Number.parseFloat(n)))
			: 0;
	},
	...
	getElement = e =>
		isElement(e) ? (e.jquery ? e[0] : e) : "string" == typeof e && e.length > 0 ? document.querySelector(e) : null,
	isVisible = e => {
...
function bootstrapHandler(e, t) {
	return function n(i) {
		return hydrateObj(i, { delegateTarget: e }), n.oneOff && EventHandler.off(e, i.type, t), t.apply(e, [i]);
	};
}
...
class Carousel extends BaseComponent {
	...
	_maybeEnableCycle() {
		this._config.ride &&
			(this._isSliding ? EventHandler.one(this._element, EVENT_SLID, () => this.cycle()) : this.cycle());
	}
	to(e) {
...
class Offcanvas extends BaseComponent {
	...
	_addEventListeners() {
		EventHandler.on(this._element, EVENT_KEYDOWN_DISMISS, e => {
			"Escape" === e.key &&
				(this._config.keyboard ? this.hide() : EventHandler.trigger(this._element, EVENT_HIDE_PREVENTED));
		});
	}
	static jQueryInterface(e) {
		return this.each(function () {
...
const uriAttributes = new Set(["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"]),
	...
	allowedAttribute = (e, t) => {
		...
		return t.includes(n)
			? !uriAttributes.has(n) || Boolean(SAFE_URL_PATTERN.test(e.nodeValue) || DATA_URL_PATTERN.test(e.nodeValue))
...
class TemplateFactory extends Config {
	...
	_checkContent(e) {
		for (const [t, n] of Object.entries(e)) super._typeCheckConfig({ selector: t, entry: n }, DefaultContentType);
	}
	_setContent(e, t, n) {
...
const NAME$2 = "scrollspy",
	...
	Default$1 = { offset: null, rootMargin: "0px 0px -25%", smoothScroll: !1, target: null, threshold: [0.1, 0.5, 1] },
	DefaultType$1 = {
		offset: "(number|null)",
		rootMargin: "string",
